...
fn keysym2code(keysym: u32) input.Keyboard.Keycode {
    return switch (keysym) {
        ...
        c.XKB_KEY_q, c.XKB_KEY_Q => .KC_Q,
        c.XKB_KEY_w, c.XKB_KEY_W => .KC_W,
        c.XKB_KEY_e, c.XKB_KEY_E => .KC_E,
        c.XKB_KEY_r, c.XKB_KEY_R => .KC_R,
        c.XKB_KEY_t, c.XKB_KEY_T => .KC_T,
        c.XKB_KEY_y, c.XKB_KEY_Y => .KC_Y,
        c.XKB_KEY_u, c.XKB_KEY_U => .KC_U,
        c.XKB_KEY_i, c.XKB_KEY_I => .KC_I,
        c.XKB_KEY_o, c.XKB_KEY_O => .KC_O,
        c.XKB_KEY_p, c.XKB_KEY_P => .KC_P,
        c.XKB_KEY_semicolon, c.XKB_KEY_colon => .KC_OEM_1,
        c.XKB_KEY_a, c.XKB_KEY_A => .KC_A,
        c.XKB_KEY_s, c.XKB_KEY_S => .KC_S,
        c.XKB_KEY_d, c.XKB_KEY_D => .KC_D,
        c.XKB_KEY_f, c.XKB_KEY_F => .KC_F,
        c.XKB_KEY_g, c.XKB_KEY_G => .KC_G,
        c.XKB_KEY_h, c.XKB_KEY_H => .KC_H,
        c.XKB_KEY_j, c.XKB_KEY_J => .KC_J,
        c.XKB_KEY_k, c.XKB_KEY_K => .KC_K,
        c.XKB_KEY_l, c.XKB_KEY_L => .KC_L,
        c.XKB_KEY_z, c.XKB_KEY_Z => .KC_Z,
        c.XKB_KEY_x, c.XKB_KEY_X => .KC_X,
        c.XKB_KEY_c, c.XKB_KEY_C => .KC_C,
        c.XKB_KEY_v, c.XKB_KEY_V => .KC_V,
        c.XKB_KEY_b, c.XKB_KEY_B => .KC_B,
        c.XKB_KEY_n, c.XKB_KEY_N => .KC_N,
        c.XKB_KEY_m, c.XKB_KEY_M => .KC_M,

        c.XKB_KEY_KP_Enter, c.XKB_KEY_ISO_Enter => .KC_RETURN,
        c.XKB_KEY_Shift_L => .KC_LSHIFT,
        c.XKB_KEY_Shift_R => .KC_RSHIFT,
        c.XKB_KEY_Tab => .KC_TAB,
        c.XKB_KEY_1, c.XKB_KEY_exclam => .KC_1,
        c.XKB_KEY_2, c.XKB_KEY_at => .KC_2,
        c.XKB_KEY_3, c.XKB_KEY_numbersign => .KC_3,
        c.XKB_KEY_4, c.XKB_KEY_dollar => .KC_4,
        c.XKB_KEY_5, c.XKB_KEY_percent => .KC_5,
        c.XKB_KEY_6, c.XKB_KEY_caret => .KC_6,
        c.XKB_KEY_7, c.XKB_KEY_ampersand => .KC_7,
        c.XKB_KEY_8, c.XKB_KEY_asterisk => .KC_8,
        c.XKB_KEY_9, c.XKB_KEY_parenleft => .KC_9,
        c.XKB_KEY_0, c.XKB_KEY_parenright => .KC_0,
        c.XKB_KEY_minus, c.XKB_KEY_underscore => .KC_OEM_MINUS,
        c.XKB_KEY_plus, c.XKB_KEY_equal => .KC_OEM_PLUS,
        else => .UNKNOWN,
    };
}
