//! Bindings for OpenGL ES 3.2 generated by zigglgen.
...
pub fn BlendBarrier() void {
    return ProcTable.current.?.BlendBarrier();
}
...
pub fn GetDebugMessageLog(count: uint, bufSize: sizei, sources: [*c]@"enum", types: [*c]@"enum", ids: [*c]uint, severities: [*c]@"enum", lengths: [*c]sizei, messageLog: [*c]char) uint {
...
pub fn GetFramebufferParameteriv(target: @"enum", pname: @"enum", params: [*c]int) void {
...
pub fn GetMultisamplefv(pname: @"enum", index: uint, val: [*c]float) void {
    return ProcTable.current.?.GetMultisamplefv(pname, index, val);
}
pub fn GetObjectLabel(identifier: @"enum", name: uint, bufSize: sizei, length: [*c]sizei, label: [*c]char) void {
    return ProcTable.current.?.GetObjectLabel(identifier, name, bufSize, length, label);
}
pub fn GetObjectPtrLabel(ptr: ?*const anyopaque, bufSize: sizei, length: [*c]sizei, label: [*c]char) void {
    return ProcTable.current.?.GetObjectPtrLabel(ptr, bufSize, length, label);
}
pub fn GetPointerv(pname: @"enum", params: [*c]?*anyopaque) void {
...
pub fn GetProgramInterfaceiv(program: uint, programInterface: @"enum", pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetProgramInterfaceiv(program, programInterface, pname, params);
}
pub fn GetProgramPipelineiv(pipeline: uint, pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetProgramPipelineiv(pipeline, pname, params);
}
pub fn GetProgramPipelineInfoLog(pipeline: uint, bufSize: sizei, length: [*c]sizei, infoLog: [*c]char) void {
    return ProcTable.current.?.GetProgramPipelineInfoLog(pipeline, bufSize, length, infoLog);
}
pub fn GetProgramResourceiv(program: uint, programInterface: @"enum", index: uint, propCount: sizei, props: [*c]const @"enum", count: sizei, length: [*c]sizei, params: [*c]int) void {
...
pub fn GetProgramResourceName(program: uint, programInterface: @"enum", index: uint, bufSize: sizei, length: [*c]sizei, name: [*c]char) void {
...
pub fn GetSamplerParameterIiv(sampler: uint, pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetSamplerParameterIiv(sampler, pname, params);
}
pub fn GetSamplerParameterIuiv(sampler: uint, pname: @"enum", params: [*c]uint) void {
...
pub fn GetTexLevelParameterfv(target: @"enum", level: int, pname: @"enum", params: [*c]float) void {
    return ProcTable.current.?.GetTexLevelParameterfv(target, level, pname, params);
}
pub fn GetTexLevelParameteriv(target: @"enum", level: int, pname: @"enum", params: [*c]int) void {
...
pub fn GetTexParameterIiv(target: @"enum", pname: @"enum", params: [*c]int) void {
    return ProcTable.current.?.GetTexParameterIiv(target, pname, params);
}
pub fn GetTexParameterIuiv(target: @"enum", pname: @"enum", params: [*c]uint) void {
...
pub fn GetnUniformfv(program: uint, location: int, bufSize: sizei, params: [*c]float) void {
    return ProcTable.current.?.GetnUniformfv(program, location, bufSize, params);
}
pub fn GetnUniformiv(program: uint, location: int, bufSize: sizei, params: [*c]int) void {
    return ProcTable.current.?.GetnUniformiv(program, location, bufSize, params);
}
pub fn GetnUniformuiv(program: uint, location: int, bufSize: sizei, params: [*c]uint) void {
...
pub fn PrimitiveBoundingBox(minX: float, minY: float, minZ: float, minW: float, maxX: float, maxY: float, maxZ: float, maxW: float) void {
    return ProcTable.current.?.PrimitiveBoundingBox(minX, minY, minZ, minW, maxX, maxY, maxZ, maxW);
}
...
pub fn ReadnPixels(x: int, y: int, width: sizei, height: sizei, format: @"enum", @"type": @"enum", bufSize: sizei, data: ?*anyopaque) void {
...
pub const ProcTable = struct {
    ...
    BlendBarrier: *const fn () callconv(APIENTRY) void,
    ...
    GetnUniformfv: *const fn (program: uint, location: int, bufSize: sizei, params: [*c]float) callconv(APIENTRY) void,
    GetnUniformiv: *const fn (program: uint, location: int, bufSize: sizei, params: [*c]int) callconv(APIENTRY) void,
    GetnUniformuiv: *const fn (program: uint, location: int, bufSize: sizei, params: [*c]uint) callconv(APIENTRY) void,
    ...
    PrimitiveBoundingBox: *const fn (minX: float, minY: float, minZ: float, minW: float, maxX: float, maxY: float, maxZ: float, maxW: float) callconv(APIENTRY) void,
